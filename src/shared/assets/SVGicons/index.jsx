...
export const LogoSVG = ({ width, height, color }) => (
  <svg width={width} height={height} viewBox='0 0 96 32' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path
      ...
      fill={color}
    />
    <path d='M59.3568 11.72L52.3728 28.28H48.9408L51.1728 23.12L46.3488 11.72H49.7568L52.1568 17.816L52.8528 20L53.5248 17.816L55.9249 11.72H59.3568Z' fill={color} />
    <path
...
// Footer
export const TitokSVG = ({ size, color }) => (
...
export const FastFoodOutlineSVG = ({ size, color }) => (
  <svg width={size} height={size} viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path
      ...
      strokeWidth='32'
    />
    <path d='M256 480h139.31a32 32 0 0031.91-29.61L463 112' fill='none' stroke={color} strokeLinecap='round' strokeMiterlimit='10' strokeWidth='32' />
    <path fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth='32' d='M368 112l16-64 47-16' />
    <path fill='none' stroke={color} strokeLinecap='round' strokeMiterlimit='10' strokeWidth='32' d='M224 112h256' />
  </svg>
);
export const CarSportsOulineSVG = ({ size, color }) => (
  <svg width={size} height={size} viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
    <path
...
export const BaseballOutlineSVG = ({ size, color }) => (
  <svg width={size} height={size} viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
    ...
    />
    <circle cx='256' cy='256' r='192' fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth='32' />
    <path
